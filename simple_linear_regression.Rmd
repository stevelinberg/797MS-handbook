...
(ref:img-slr1) Simple linear regression plot (source: [ISLR2](https://www.statlearning.com/), p. 62)
...
ggplot(data = Boston, aes(x = lstat, y = medv)) +
  ...
  geom_vline(xintercept = mean(Boston$lstat), linetype = "dashed", color = "green") +
  theme_minimal()
```
