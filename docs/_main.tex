...
\NormalTok{boston\_lda.class }\OtherTok{\textless{}{-}}\NormalTok{ boston\_lda.pred}\SpecialCharTok{$}\NormalTok{class}
\FunctionTok{table}\NormalTok{(boston\_lda.class, boston[boston.test,]}\SpecialCharTok{$}\NormalTok{crim\_above\_med)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(boston\_lda.class }\SpecialCharTok{==}\NormalTok{ boston[boston.test,]}\SpecialCharTok{$}\NormalTok{crim\_above\_med)}
\end{Highlighting}
\end{Shaded}
