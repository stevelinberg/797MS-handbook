...
Each chapter should have a [TL;DR](https://en.wikipedia.org/wiki/Wikipedia:Too_long;_didn%27t_read) section at the top with one-sentence answers to following questions:
...
and it should be possible to page through the book, just reading the TL;DR sections, and get a reasonable overview without reading the rest. The rest of each chapter should deliver fleshed-out, but *short*, answers to the same questions, covering the basics and the most general concepts.
